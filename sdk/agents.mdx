...
<Tip>
For programmatic connection management (create without browser, set trust modes, test connectivity), use the [`MemoryClient`](/sdk/agents-client#connections) directly via `agent.runtime`.
</Tip>
